 ...
 */
#ifndef ORG_OBINJECT_STORAGE_ENTITYSTRUCTURE_H
#define	ORG_OBINJECT_STORAGE_ENTITYSTRUCTURE_H
...
template <typename E>
class EntityStructure : public Structure<E> {
public:
...
template <typename E>
inline EntityStructure<E>::~EntityStructure() {
}
...
#endif	/* ORG_OBINJECT_STORAGE_ENTITYSTRUCTURE_H */
